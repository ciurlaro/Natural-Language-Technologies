...
output_csv = Path.cwd() / 'output' / 'output.csv'
words_dataset_csv = Path.cwd() / 'output' / 'words.csv'
...
words, track_ids = data_loading(db_file, h5_file, musiXmatch_file, data, output_csv, words_dataset_csv)